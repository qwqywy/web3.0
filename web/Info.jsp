<%--@elvariable id="basicInfo" type="com.example.pgms.bean.BasicInfo"--%>
<%--@elvariable id="admissionInfo" type="com.example.pgms.bean.AdmissionInfo"--%>
<%--@elvariable id="extensionInfo" type="com.example.pgms.bean.ExtendedInfo"--%>
<%--@elvariable id="educationExperience" type="com.example.pgms.bean.EducationExperience"--%>
<%--@elvariable id="workExperience" type="com.example.pgms.bean.WorkExperience"--%>
