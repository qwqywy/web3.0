...
@WebServlet("/CollegeleaderView")
public class CollegeleaderViewServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // 转发到JSP页面
        request.getRequestDispatcher("/collegeleaderManage.jsp").forward(request, response);
    }
}
