...
@WebServlet("/schoolleaderView")
public class schoolleaderViewServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // 转发到JSP页面
        request.getRequestDispatcher("/schoolleaderView.jsp").forward(request, response);
    }
}
